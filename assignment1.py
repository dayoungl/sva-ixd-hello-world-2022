...
noun2 = raw_input("Animal:")
noun3 = raw_input("Plural Noun:")
game = raw_input("Game:")
noun4 = raw_input("Plural Noun:")
gerund1 = raw_input("Noun + ing:")
gerund2 = raw_input("Noun + ing:")
noun5 = raw_input("Plural Noun:")
gerund3 = raw_input("Noun + ing:")
noun6 = raw_input("Noun:")
plant = raw_input("Plant:")
body = raw_input("Parts of the body:")
place = raw_input("Place")
gerund4 = raw_input("Noun + ing:")
adj3 =raw_input("Adjective:")
number = raw_input("Number:")
noun7 = raw_input("Plural Nouns:")
